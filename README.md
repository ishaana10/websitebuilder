# Nuvis WebDesign X Website Builder

Nuvis WebDesign X is a full, commercial-grade visual website builder developed with highly modular, secure, low-code paradigms. Compatible with **PHP 8.1 to 8.3+** and **MySQL/MariaDB**, Nuvis WebDesign X is engineered for performance, security, and developer extensibility as proprietary software by **nuvistechnologies.com.fj**.
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/yourusername/nuvis-webdesign-x-site-builder.git
   cd nuvis-webdesign-x-site-builder
   ```
...
- **PHP Version Issues:**
  - Nuvis WebDesign X is compatible with PHP 8.1 up to PHP 8.3+. Running older PHP versions (< 8.1) will result in syntax errors like array destructuring or short open tags. Check version with `php -v`.
...
Copyright (c) 2024 Nuvis WebDesign X. All Rights Reserved. Proprietary software owned exclusively by nuvistechnologies.com.fj.
