...
def run_verification(page):
    ...
    username = f"dev_{ts}"
    email = f"dev_{ts}@nuvis-webdesign-x.io"
    password = "securepass123"

    print("Navigating to Nuvis WebDesign X Landing Portal...")
    ...
    page.wait_for_timeout(500)
    page.click("form[onsubmit*='sendNuvisWebDesignXChatMessage'] button[type='submit']")
    ...
    page.click("form[onsubmit*='submitNuvisWebDesignXForm'] button[type='submit']")
